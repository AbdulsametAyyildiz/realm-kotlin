...
object Versions {
    ...
    const val serialization = "1.11.0" // https://kotlinlang.org/docs/releases.html#release-details
    const val shadowJar =  "8.1.1" // https://github.com/johnrengelman/shadow (last version under johnrengelman namespace; later versions moved to com.gradleup.shadow)
